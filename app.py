...
def fetch_fundamental_snapshot(ticker):
    ...
    q_cfo=_statement_row(qc,["Operating Cash Flow","Total Cash From Operating Activities","Cash Flow From Continuing Operating Activities"])
    q_capex=_statement_row(qc,["Capital Expenditure","Capital Expenditures"])
    a_cfo=_statement_row(ac,["Operating Cash Flow","Total Cash From Operating Activities","Cash Flow From Continuing Operating Activities"])
